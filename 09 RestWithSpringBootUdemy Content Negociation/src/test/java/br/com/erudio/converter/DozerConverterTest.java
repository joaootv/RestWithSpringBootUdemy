...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        Assert.assertEquals("Last Name Test0", output.getLasName());
    ...
    public void parseEntityListToVOListTest() {
        ...
        Assert.assertEquals("Last Name Test0", outputZero.getLasName());
        ...
        Assert.assertEquals("Last Name Test7", outputSeven.getLasName());
        ...
        Assert.assertEquals("Last Name Test12", outputTwelve.getLasName());
